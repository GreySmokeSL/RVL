...
namespace ArtistsWebBilling.Helper
{
    ...
    public class EnumerableDataReader<T> : IDataReader
    {
        ...
        public EnumerableDataReader(IEnumerable<T> collection, string[] fields)
        {
            if (collection == null)
        ...
        private abstract class BaseField
        {
            ...
            private readonly Dictionary<string, Func<T, object>> m_GetterDictionary = new Dictionary<string, Func<T, object>>();
        }
